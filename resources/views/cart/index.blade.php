...
<style>
  :root {
    ...
    --shadow-3d: 0 4px 12px rgba(0, 0, 0, 0.08), 0 2px 6px rgba(0, 0, 0, 0.05);
...
.product-name {
  ...
  line-height: 1.2;           /* keeps spacing neat */
}
      ...
      <div class="order-summary">
        ...
        <div class="summary-body">
          ...
          <div class="items-summary mb-4">
            ...
            $subtotal += $itemTotal;
            @endphp
            <div class="summary-item p-3 rounded mb-2 bg-light" style="display: flex; justify-content: space-between; align-items: flex-start;">
              <div style="flex: 1; padding-right: 15px; overflow: hidden;">
                <small class="d-block mb-1" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><strong>Name:</strong> {{ $item['name'] }}</small>
                <small class="d-block text-muted"><strong>Qty:</strong> {{ $item['quantity'] }}</small>
              </div>
              <div style="text-align: right; white-space: nowrap; min-width: 100px;">
                ...
                <strong class="d-block">₹{{ number_format($itemTotal, 2) }}</strong>
              </div>
            </div>
            @empty
